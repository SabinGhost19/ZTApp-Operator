...
* graceful Falco/Talon missing detection across operator → backend → UI ([dfbbd7b](https://github.com/SabinGhost19/ZTApp-Operator/commit/dfbbd7b94eede4667af162298057d87419303dca))
